...
function rmDisp() {
  ...
  do {
    ...
    if (rmcalLang == 'my-Mon' || rmcalLang == 'my-mon')
      rLang = 3; //Mon language
    else if (rmcalLang == 'my-En' || rmcalLang == 'my-en')
      rLang = 0; //English
    else if (
      rmcalLang == 'my-Z1' ||
      ormcal.style.fontFamily == 'Zawgyi-One' ||
      rmcalLang == 'my-z1'
    )
      rLang = 2; // Zawgyi font
    else if (rmcalLang == 'my-Tai' || rmcalLang == 'my-tai')
      rLang = 4; //Tai language
    ...
    ormcal.href = 'https://yan9a.github.io/mmcal/';
...
function rmStr(rLang) {
  ...
  var str =
    ...
    ' ';
  str +=
    grX['Myanmar Year'] + ' ' + rn2s(M.my) + ' ' + grX['Ku'] + grX[','] + ' ';
